      ...
      <div>
        <nav className="navbar fixed-top navbar-expand-lg bg-info" style={{height:'3.5rem'}}>
            <div className="container-fluid">
                <Link className="navbar-brand" to="/"> DAILY DOZE</Link>
                ...
                <ul className="navbar-nav me-auto mb-3 mb-lg-0">
                    ...
                    <li className="nav-item">
                    <a className="nav-link" target={'_blank'} href="https://github.com/Sahil-Jangra2622" data-bs-toggle="tooltip" data-bs-placement="top" title="About Author" >About us</a>
                    </li>
                    <li className="nav-item">
